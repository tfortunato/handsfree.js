          ...
          v-card-text
            ...
            v-expansion-panel(v-model='tab')
              v-expansion-panel-content
                ...
                v-card
                  v-card-text
                    p This is how we encourage you to use Handsfree.js when using standard web technologies or when experimenting on sites like <a href="https://glitch.com/~handsfree-starter">Glitch.com (check out the Handsfree Starter!)</a>. Because Handsfree.js is constantly being updated, we strongly recommend using either a specific version or limiting it to a major version:
                    pre 
                      code.xml.
