...
module.exports = Handsfree => {
  ...
  Handsfree.prototype.use = function (config) {
    ...
    config.disable = function () {this._isDisabled = true}
    config.enable = function () {this._isDisabled = false}
  ...
  Handsfree.prototype.onStopHooks = function () {
    forEach(this.plugin, (config) => {
      config.onStop && config.onStop.call(config, this)
    })
  }
  ...
  Handsfree.prototype.onStartHooks = function () {
    forEach(this.plugin, (config) => {
      config.onStart && config.onStart.call(config, this)
    })
  }
